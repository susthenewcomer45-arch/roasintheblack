...
export const metadata: Metadata = {
  ...
  description: 'Learn to calculate break-even ROAS in seconds. Discover the exact ad spend multiplier your campaigns need to stay profitable.',
  alternates: { canonical: 'https://roasintheblack.com/blog/2-how-to-calculate-breakeven-roas-in-under-60-seconds' },
  openGraph: {
    title: '2. How to Calculate Break-Even ROAS in Under 60 Seconds | ROAS in the Black',
    description: 'Learn to calculate break-even ROAS in seconds. Discover the exact ad spend multiplier your campaigns need to stay profitable.',
    url: 'https://roasintheblack.com/blog/2-how-to-calculate-breakeven-roas-in-under-60-seconds',
  },
}
...
const sections: Section[] = [
  ...
  {
    "heading": "What Is Break-Even ROAS?",
    "paragraphs": [
  ...
  {
    "heading": "Why Most Marketers Get This Wrong",
    "paragraphs": [
  ...
  {
    "heading": "Using Break-Even ROAS to Build Better Campaigns",
    "paragraphs": [
  ...
  {
    "heading": "Calculate Your Break-Even ROAS Right Now",
    "paragraphs": [
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      <article className="space-y-6">
        <header className="space-y-3">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed">Learn to calculate break-even ROAS in seconds. Discover the exact ad spend multiplier your campaigns need to stay profitable.</p>
        </header>
