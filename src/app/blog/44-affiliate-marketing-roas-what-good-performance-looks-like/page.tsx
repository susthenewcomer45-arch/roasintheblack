...
export const metadata: Metadata = {
  title: '44. Affiliate Marketing ROAS: What Good Performance Looks Like | ROAS in the Black',
  description: 'Learn what good ROAS looks like in affiliate marketing. Discover benchmarks, profitability thresholds, and how to calculate your break-even ROAS.',
  alternates: { canonical: 'https://roasintheblack.com/blog/44-affiliate-marketing-roas-what-good-performance-looks-like' },
  openGraph: {
    title: '44. Affiliate Marketing ROAS: What Good Performance Looks Like | ROAS in the Black',
    description: 'Learn what good ROAS looks like in affiliate marketing. Discover benchmarks, profitability thresholds, and how to calculate your break-even ROAS.',
    url: 'https://roasintheblack.com/blog/44-affiliate-marketing-roas-what-good-performance-looks-like',
  },
}
...
const sections: Section[] = [
  ...
  {
    "heading": "Why ROAS Benchmarks Mislead You",
    "paragraphs": [
  ...
  {
    "heading": "Calculate Your Break-Even ROAS",
    "paragraphs": [
  ...
  {
    "heading": "What Good ROAS Looks Like in Practice",
    "paragraphs": [
  ...
  {
    "heading": "Scaling When You're Above Break-Even",
    "paragraphs": [
      ...
      <article className="space-y-6">
        <header className="space-y-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-zinc-100 leading-tight">
            44. Affiliate Marketing ROAS: What Good Performance Looks Like
          </h1>
          <p className="text-zinc-400 text-lg leading-relaxed">Learn what good ROAS looks like in affiliate marketing. Discover benchmarks, profitability thresholds, and how to calculate your break-even ROAS.</p>
        </header>
        ...
        <RelatedArticles currentSlug="44-affiliate-marketing-roas-what-good-performance-looks-like" />
