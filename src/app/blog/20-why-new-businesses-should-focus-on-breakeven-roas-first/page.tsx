...
export const metadata: Metadata = {
  title: '20. Why New Businesses Should Focus on Break-Even ROAS First | ROAS in the Black',
  description: 'Learn why new businesses should prioritize break-even ROAS before scaling ad spend. Master profitability metrics that actually matter.',
  alternates: { canonical: 'https://roasintheblack.com/blog/20-why-new-businesses-should-focus-on-breakeven-roas-first' },
  openGraph: {
    title: '20. Why New Businesses Should Focus on Break-Even ROAS First | ROAS in the Black',
    description: 'Learn why new businesses should prioritize break-even ROAS before scaling ad spend. Master profitability metrics that actually matter.',
    url: 'https://roasintheblack.com/blog/20-why-new-businesses-should-focus-on-breakeven-roas-first',
  },
}
...
const sections: Section[] = [
  {
    "paragraphs": [
      "Most new businesses make the same mistake with paid advertising: they focus on vanity metrics instead of survival metrics. They chase lower cost-per-acquisition, celebrate high click-through rates, and obsess over impression volume. Meanwhile, they're bleeding money on ads that don't cover their costs. The truth is simpler and more urgent. Before you scale ad spend to $10,000 a month or $100,000 a month, you need to know the absolute minimum ROAS required just to break even.",
  ...
  {
    "heading": "The Cost of Ignoring Break-Even ROAS",
    "paragraphs": [
  ...
  {
    "heading": "Breaking Down the Break-Even Math",
    "paragraphs": [
  ...
  {
    "heading": "Why Profitability ROAS Is Different From Break-Even ROAS",
    "paragraphs": [
  ...
  {
    "heading": "The Path From Break-Even to Scale",
    "paragraphs": [
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      <article className="space-y-6">
        <header className="space-y-3">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed">Learn why new businesses should prioritize break-even ROAS before scaling ad spend. Master profitability metrics that actually matter.</p>
        </header>
        ...
        <RelatedArticles currentSlug="20-why-new-businesses-should-focus-on-breakeven-roas-first" />
