...
export const metadata: Metadata = {
  title: '29. Insurance Advertising ROAS: Industry Benchmarks | ROAS in the Black',
  description: 'Learn insurance advertising ROAS benchmarks, industry standards, and how to calculate break-even ROAS for profitable ad campaigns.',
  alternates: { canonical: 'https://roasintheblack.com/blog/29-insurance-advertising-roas-industry-benchmarks' },
  openGraph: {
    title: '29. Insurance Advertising ROAS: Industry Benchmarks | ROAS in the Black',
    description: 'Learn insurance advertising ROAS benchmarks, industry standards, and how to calculate break-even ROAS for profitable ad campaigns.',
    url: 'https://roasintheblack.com/blog/29-insurance-advertising-roas-industry-benchmarks',
  },
}
...
const sections: Section[] = [
  ...
  {
    "heading": "What Is ROAS and Why It Matters for Insurance Campaigns",
    "paragraphs": [
  ...
  {
    "heading": "Insurance Advertising ROAS Benchmarks by Channel",
    "paragraphs": [
  ...
  {
    "heading": "Calculating Your Break-Even ROAS: A Worked Example",
    "paragraphs": [
  ...
  {
    "heading": "How to Improve Insurance Advertising ROAS",
    "paragraphs": [
  ...
  {
    "heading": "Taking Action on Your Insurance ROAS",
    "paragraphs": [
      ...
      <article className="space-y-6">
        <header className="space-y-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-zinc-100 leading-tight">
            29. Insurance Advertising ROAS: Industry Benchmarks
          </h1>
          <p className="text-zinc-400 text-lg leading-relaxed">Learn insurance advertising ROAS benchmarks, industry standards, and how to calculate break-even ROAS for profitable ad campaigns.</p>
        </header>
        ...
        <RelatedArticles currentSlug="29-insurance-advertising-roas-industry-benchmarks" />
