...
export const metadata: Metadata = {
  title: '1. What Is ROAS and Why Does It Matter for Your Business? | ROAS in the Black',
  description: 'Learn what ROAS means, why it matters for paid advertising, and how to calculate break-even ROAS for profitable campaigns.',
  alternates: { canonical: 'https://roasintheblack.com/blog/1-what-is-roas-and-why-does-it-matter-for-your-business' },
  openGraph: {
    title: '1. What Is ROAS and Why Does It Matter for Your Business? | ROAS in the Black',
    description: 'Learn what ROAS means, why it matters for paid advertising, and how to calculate break-even ROAS for profitable campaigns.',
    url: 'https://roasintheblack.com/blog/1-what-is-roas-and-why-does-it-matter-for-your-business',
  },
}
...
const sections: Section[] = [
  ...
  {
    "heading": "The Definition: What Is ROAS?",
    "paragraphs": [
  ...
  {
    "heading": "Why ROAS Matters More Than You Think",
    "paragraphs": [
  ...
  {
    "heading": "Break-Even ROAS: The Number That Changes Everything",
    "paragraphs": [
  ...
  {
    "heading": "ROAS Across Different Platforms and Business Models",
    "paragraphs": [
  ...
  {
    "heading": "Start with Break-Even ROAS",
    "paragraphs": [
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      <article className="space-y-6">
        <header className="space-y-3">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed">Learn what ROAS means, why it matters for paid advertising, and how to calculate break-even ROAS for profitable campaigns.</p>
        </header>
        ...
        <RelatedArticles currentSlug="1-what-is-roas-and-why-does-it-matter-for-your-business" />
