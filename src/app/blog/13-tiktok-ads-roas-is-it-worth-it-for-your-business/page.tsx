...
export const metadata: Metadata = {
  title: '13. TikTok Ads ROAS: Is It Worth It for Your Business? | ROAS in the Black',
  description: 'Discover if TikTok ads deliver real ROI for your business. Learn ROAS benchmarks, cost factors, and how to calculate profitability.',
  alternates: { canonical: 'https://roasintheblack.com/blog/13-tiktok-ads-roas-is-it-worth-it-for-your-business' },
  openGraph: {
    title: '13. TikTok Ads ROAS: Is It Worth It for Your Business? | ROAS in the Black',
    description: 'Discover if TikTok ads deliver real ROI for your business. Learn ROAS benchmarks, cost factors, and how to calculate profitability.',
    url: 'https://roasintheblack.com/blog/13-tiktok-ads-roas-is-it-worth-it-for-your-business',
  },
}
...
const sections: Section[] = [
  ...
  {
    "heading": "What Is a Good ROAS on TikTok?",
    "paragraphs": [
  ...
  {
    "heading": "TikTok Ad Costs and Spend Realities",
    "paragraphs": [
  ...
  {
    "heading": "Industry Benchmarks for TikTok ROAS",
    "paragraphs": [
  ...
  {
    "heading": "Is TikTok Ads Worth Your Budget?",
    "paragraphs": [
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      <article className="space-y-6">
        <header className="space-y-3">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed">Discover if TikTok ads deliver real ROI for your business. Learn ROAS benchmarks, cost factors, and how to calculate profitability.</p>
        </header>
        ...
        <RelatedArticles currentSlug="13-tiktok-ads-roas-is-it-worth-it-for-your-business" />
