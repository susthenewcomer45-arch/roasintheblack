...
export const metadata: Metadata = {
  title: '17. How to Improve Your ROAS Without Increasing Ad Spend | ROAS in the Black',
  description: 'Learn how to improve ROAS without increasing ad spend. Optimize targeting, creative, and bidding to maximize returns on existing budgets.',
  alternates: { canonical: 'https://roasintheblack.com/blog/17-how-to-improve-your-roas-without-increasing-ad-spend' },
  openGraph: {
    title: '17. How to Improve Your ROAS Without Increasing Ad Spend | ROAS in the Black',
    description: 'Learn how to improve ROAS without increasing ad spend. Optimize targeting, creative, and bidding to maximize returns on existing budgets.',
    url: 'https://roasintheblack.com/blog/17-how-to-improve-your-roas-without-increasing-ad-spend',
  },
}
...
const sections: Section[] = [
  ...
  {
    "heading": "Refine Your Audience Targeting",
    "paragraphs": [
  ...
  {
    "heading": "Optimize Creative Without Budget Inflation",
    "paragraphs": [
  ...
  {
    "heading": "Tighten Your Conversion Funnel",
    "paragraphs": [
  ...
  {
    "heading": "A Practical Example: The Math Behind Optimization",
    "paragraphs": [
  ...
  {
    "heading": "Master Bid Strategy and Bid Adjustments",
    "paragraphs": [
      ...
      <article className="space-y-6">
        <header className="space-y-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-zinc-100 leading-tight">
            17. How to Improve Your ROAS Without Increasing Ad Spend
          </h1>
          <p className="text-zinc-400 text-lg leading-relaxed">Learn how to improve ROAS without increasing ad spend. Optimize targeting, creative, and bidding to maximize returns on existing budgets.</p>
        </header>
        ...
        <RelatedArticles currentSlug="17-how-to-improve-your-roas-without-increasing-ad-spend" />
