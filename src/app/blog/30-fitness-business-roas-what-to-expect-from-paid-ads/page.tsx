...
export const metadata: Metadata = {
  title: '30. Fitness Business ROAS: What to Expect From Paid Ads | ROAS in the Black',
  description: 'Learn what ROAS fitness businesses should expect from paid ads and how to calculate break-even spend for profitable campaigns.',
  alternates: { canonical: 'https://roasintheblack.com/blog/30-fitness-business-roas-what-to-expect-from-paid-ads' },
  openGraph: {
    title: '30. Fitness Business ROAS: What to Expect From Paid Ads | ROAS in the Black',
    description: 'Learn what ROAS fitness businesses should expect from paid ads and how to calculate break-even spend for profitable campaigns.',
    url: 'https://roasintheblack.com/blog/30-fitness-business-roas-what-to-expect-from-paid-ads',
  },
}
...
const sections: Section[] = [
  ...
  {
    "heading": "What is ROAS and Why It Matters for Fitness Businesses",
    "paragraphs": [
  ...
  {
    "heading": "Typical ROAS Benchmarks for Fitness Paid Ads",
    "paragraphs": [
  ...
  {
    "heading": "Calculating Your Break-Even ROAS: A Real Example",
    "paragraphs": [
  ...
  {
    "heading": "How to Set Realistic ROAS Targets for Your Fitness Ads",
    "paragraphs": [
  ...
  {
    "heading": "Using Data to Scale Profitably",
    "paragraphs": [
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      <article className="space-y-6">
        <header className="space-y-3">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed">Learn what ROAS fitness businesses should expect from paid ads and how to calculate break-even spend for profitable campaigns.</p>
        </header>
        ...
        <RelatedArticles currentSlug="30-fitness-business-roas-what-to-expect-from-paid-ads" />
