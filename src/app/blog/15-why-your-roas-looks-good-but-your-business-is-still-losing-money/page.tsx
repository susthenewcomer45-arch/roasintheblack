...
export const metadata: Metadata = {
  title: '15. Why Your ROAS Looks Good But Your Business Is Still Losing Money | ROAS in the Black',
  description: 'Your ROAS looks profitable but your business is losing money. Learn why vanity metrics miss hidden costs and how to calculate true break-even ROAS.',
  alternates: { canonical: 'https://roasintheblack.com/blog/15-why-your-roas-looks-good-but-your-business-is-still-losing-money' },
  openGraph: {
    title: '15. Why Your ROAS Looks Good But Your Business Is Still Losing Money | ROAS in the Black',
    description: 'Your ROAS looks profitable but your business is losing money. Learn why vanity metrics miss hidden costs and how to calculate true break-even ROAS.',
    url: 'https://roasintheblack.com/blog/15-why-your-roas-looks-good-but-your-business-is-still-losing-money',
  },
}
...
const sections: Section[] = [
  ...
  {
    "heading": "The ROAS Illusion: Why Revenue Isn't Profit",
    "paragraphs": [
  ...
  {
    "heading": "A Real Example: The $10,000 Ad Spend That Lost $3,000",
    "paragraphs": [
  ...
  {
    "heading": "The Hidden Costs ROAS Ignores",
    "paragraphs": [
  ...
  {
    "heading": "How to Find Your Real Break-Even ROAS",
    "paragraphs": [
  ...
  {
    "heading": "The Takeaway: Measure What Matters",
    "paragraphs": [
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      <article className="space-y-6">
        <header className="space-y-3">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed">Your ROAS looks profitable but your business is losing money. Learn why vanity metrics miss hidden costs and how to calculate true break-even ROAS.</p>
        </header>
        ...
        <RelatedArticles currentSlug="15-why-your-roas-looks-good-but-your-business-is-still-losing-money" />
