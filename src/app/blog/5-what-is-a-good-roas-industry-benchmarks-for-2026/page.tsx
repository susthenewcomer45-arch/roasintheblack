...
export const metadata: Metadata = {
  title: '5. What Is a Good ROAS? Industry Benchmarks for 2026 | ROAS in the Black',
  description: 'Discover what constitutes a good ROAS in 2026. Learn industry benchmarks, factors that affect profitability, and how to set realistic targets for your ad spend.',
  alternates: { canonical: 'https://roasintheblack.com/blog/5-what-is-a-good-roas-industry-benchmarks-for-2026' },
  openGraph: {
    title: '5. What Is a Good ROAS? Industry Benchmarks for 2026 | ROAS in the Black',
    description: 'Discover what constitutes a good ROAS in 2026. Learn industry benchmarks, factors that affect profitability, and how to set realistic targets for your ad spend.',
    url: 'https://roasintheblack.com/blog/5-what-is-a-good-roas-industry-benchmarks-for-2026',
  },
}
...
const sections: Section[] = [
  ...
  {
    "heading": "Industry Benchmarks: What the Data Shows",
    "paragraphs": [
  ...
  {
    "heading": "Breaking Down Your Break-Even ROAS",
    "paragraphs": [
  ...
  {
    "heading": "Platform-Specific ROAS Targets for 2026",
    "paragraphs": [
  ...
  {
    "heading": "Factors That Shape Your Good ROAS",
    "paragraphs": [
  ...
  {
    "heading": "Moving Beyond the ROAS Number",
    "paragraphs": [
      ...
      <article className="space-y-6">
        <header className="space-y-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-zinc-100 leading-tight">
            5. What Is a Good ROAS? Industry Benchmarks for 2026
          </h1>
          <p className="text-zinc-400 text-lg leading-relaxed">Discover what constitutes a good ROAS in 2026. Learn industry benchmarks, factors that affect profitability, and how to set realistic targets for your ad spend.</p>
        </header>
        ...
        <RelatedArticles currentSlug="5-what-is-a-good-roas-industry-benchmarks-for-2026" />
