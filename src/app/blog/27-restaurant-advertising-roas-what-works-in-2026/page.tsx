...
export const metadata: Metadata = {
  ...
  description: 'Learn what restaurant advertising ROAS targets work in 2026. Calculate break-even ROAS and optimize ad spend across Google, Meta, and TikTok.',
  alternates: { canonical: 'https://roasintheblack.com/blog/27-restaurant-advertising-roas-what-works-in-2026' },
  openGraph: {
    title: '27. Restaurant Advertising ROAS: What Works in 2026 | ROAS in the Black',
    description: 'Learn what restaurant advertising ROAS targets work in 2026. Calculate break-even ROAS and optimize ad spend across Google, Meta, and TikTok.',
    url: 'https://roasintheblack.com/blog/27-restaurant-advertising-roas-what-works-in-2026',
  },
}
...
const sections: Section[] = [
  ...
  {
    "heading": "Restaurant ROAS Benchmarks for 2026",
    "paragraphs": [
  ...
  {
    "heading": "Calculating Your Break-Even ROAS: A Restaurant Example",
    "paragraphs": [
  ...
  {
    "heading": "Platform-Specific Strategies for Restaurant Ad Spend",
    "paragraphs": [
  ...
  {
    "heading": "Optimizing Ad Spend Without Guessing",
    "paragraphs": [
  ...
  {
    "heading": "Know Your Number Before You Spend",
    "paragraphs": [
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      <article className="space-y-6">
        <header className="space-y-3">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed">Learn what restaurant advertising ROAS targets work in 2026. Calculate break-even ROAS and optimize ad spend across Google, Meta, and TikTok.</p>
        </header>
