...
export const metadata: Metadata = {
  title: '3. Why Most Businesses Are Losing Money on Ads Without Knowing It | ROAS in the Black',
  description: 'Most businesses lose money on ads without realizing it. Learn why ROAS blindness costs you profits and how to fix it.',
  alternates: { canonical: 'https://roasintheblack.com/blog/3-why-most-businesses-are-losing-money-on-ads-without-knowing-it' },
  openGraph: {
    title: '3. Why Most Businesses Are Losing Money on Ads Without Knowing It | ROAS in the Black',
    description: 'Most businesses lose money on ads without realizing it. Learn why ROAS blindness costs you profits and how to fix it.',
    url: 'https://roasintheblack.com/blog/3-why-most-businesses-are-losing-money-on-ads-without-knowing-it',
  },
}
...
const sections: Section[] = [
  ...
  {
    "heading": "The ROAS Illusion: Why Your Dashboard Lies",
    "paragraphs": [
  ...
  {
    "heading": "A Real Example: The Math Behind the Loss",
    "paragraphs": [
  ...
  {
    "heading": "Why This Happens to Smart Marketers",
    "paragraphs": [
  ...
  {
    "heading": "How to Stop Losing Money Right Now",
    "paragraphs": [
  ...
  {
    "heading": "The Profitable Path Forward",
    "paragraphs": [
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      <article className="space-y-6">
        <header className="space-y-3">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed">Most businesses lose money on ads without realizing it. Learn why ROAS blindness costs you profits and how to fix it.</p>
        </header>
        ...
        <RelatedArticles currentSlug="3-why-most-businesses-are-losing-money-on-ads-without-knowing-it" />
